            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <Card variant="glass" className="backdrop-blur-xl">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between p-4 rounded-lg bg-accent-green/10 border border-accent-green/20">
                      <div>
                        <p className="text-sm text-text-secondary">신규 환자 증가율</p>
                        <p className="text-2xl font-bold text-accent-green">+35%</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-4 rounded-lg bg-accent-blue/10 border border-accent-blue/20">
                      <div>
                    ...
                    <div className="flex items-center justify-between p-4 rounded-lg bg-accent-purple/10 border border-accent-purple/20">
                      <div>
                        <p className="text-sm text-text-secondary">ROI (투자수익률)</p>
                        <p className="text-2xl font-bold text-accent-purple">280%</p>
                      </div>
